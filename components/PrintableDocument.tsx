...
export const PrintableDocument: React.FC<PrintableDocumentProps> = ({ data, id }) => {
  ...
  // Professional styles for the form sections
  ...
  return (
    <div 
      ...
      className="bg-white text-black font-sans w-[210mm] min-h-[297mm] mx-auto relative box-border flex flex-col p-[2mm] border-[4px] border-black"
    >
      {/* Inner Decorative Border */}
      <div className="border border-black flex-1 flex flex-col p-[12mm]">
        {/* Header Section */}
        ...
        <div className="mt-8">
            ...
            <div className="text-center mt-2 text-[8px] text-gray-400 font-medium uppercase tracking-wider">
